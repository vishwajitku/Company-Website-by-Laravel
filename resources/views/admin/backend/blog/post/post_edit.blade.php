...
<div class="">
                                <div class="card">
                                    ...
                                    <div class="card-body">
                                        <form class="row g-3" action="{{ route('post.edit.store' , $post->id) }}" method="post" enctype = "multipart/form-data" >
                                            @csrf
                                          
                                            <div class="col-md-9">
                                                <label for="validationDefault02" class="form-label">Tittle</label>
                                                <input type="text" value="{{ $post->post_title }}" name="post_title" class="form-control" id="validationDefault02"  required="">
                                            </div>
     ...
     <img id="showImage" src="{{ !empty($post->image) ? url($post->image)
